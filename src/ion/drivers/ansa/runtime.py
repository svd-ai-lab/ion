...
def _get_iap_module():
    ...
    import sys
    from ion.drivers.ansa.driver import _find_installation
...
class AnsaRuntime:
    ...
    def __init__(self, ion_dir: Path | None = None):
        self._ion_dir = ion_dir or (Path.cwd() / ".ion")
    ...
    def launch(self, port: int | None = None, ui_mode: str = "gui") -> SessionInfo:
        ...
        from ion.drivers.ansa.driver import _find_installation, _extract_version
        install = _find_installation()
        if install is None:
