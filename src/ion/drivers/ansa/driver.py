...
class AnsaDriver:
    ...
    def _run_python(self, script: Path, bat_path: str) -> RunResult:
        ...
        tmp_dir = tempfile.mkdtemp(prefix="ion_ansa_")
        wrapper = os.path.join(tmp_dir, "_ion_run.bat")
    ...
    def _ensure_runtime(self):
        if self._runtime is None:
            from ion.drivers.ansa.runtime import AnsaRuntime
