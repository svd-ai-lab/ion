"""Simcenter Flotherm driver for ion.
...
from ion.driver import ConnectionInfo, Diagnostic, LintResult, RunResult
from ion.drivers.flotherm._helpers import (
...
class FlothermDriver:
    """Ion driver for Simcenter Flotherm.
    ...
    def query_status(self) -> dict:
        ...
        from ion.drivers.flotherm._helpers import is_process_alive
    ...
    def _write_script(self, xml_content: str, label: str) -> str:
        ...
        path = os.path.join(ws, f"_ion_{safe}.xml")
