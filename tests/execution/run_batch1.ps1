...
Set-Location "E:\Code_MCP\ion\ion-main"

$BATCH_TS      = Get-Date -Format "yyyyMMdd_HHmmss"
$BATCH_LOG     = "E:\Code_MCP\ion\ion-main\tests\execution\logs\batch1_${BATCH_TS}_summary.log"
$SCRIPT_DIR    = "E:\Code_MCP\ion\ion-main\tests\execution"
